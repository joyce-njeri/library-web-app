...
class data extends db {
    ...
    function addnewuser($firstname,$lastname,$role,$email,$password){
        ...
        $this->password=$password;
         ...
         $q="INSERT INTO users(id, firstname, lastname, role, email, password)VALUES('','$firstname','$lastname','$role','$email','$password')";
