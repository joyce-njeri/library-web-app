...
<body>
    ...
    <main>
        ...
        <div class="background"><img class="imgbackground" src="../images/background.jpg" />
            ...
            padding: 8px;'>Person Name</th><th>Role</th><th>Book Name</th><th>Days</th><th>Approve</th></tr>";
                    ...
                    <div class="rightinnerdiv">
                        <div id="addbook" class="innerright portion" style="<?php if (!empty($_REQUEST['viewid'])) {
                            ...
                            <form class="form-group" action="add_book.php" method="post" enctype="multipart/form-data">
                                <div class="addbook-input">
                                    <label>Book Name:</label><input type="text" name="bookname" style="width: 250px;" />
                                </div>
                                <!-- </br> -->
                                <div class="addbook-input">
                                    <label>Detail:</label><input type="text" name="bookdetail" style="width: 250px;" />
                                </div>
                                <!-- </br> -->
                                <div class="addbook-input">
                                    <label>Author:</label><input type="text" name="bookauthor" style="width: 250px;" />
                                </div>

                                <!-- </br> -->
                                <div class="addbook-input">
                                    <label>Publication</label><input type="text" name="bookpub" style="width: 250px;" />
                                </div>
                                <!-- </br> -->
                                <div class="addbook-input">
                                ...
                                <div class="addbook-input">
                                    <label>Price:</label><input type="number" name="bookprice" style="width: 250px;" />
                                </div>
                                <!-- </br> -->
                                <div class="addbook-input">
                                    <label>Quantity:</label><input type="number" name="bookquantity" style="width: 250px;" />
                                </div>
                                <!-- </br> -->
                                <div class="addbook-input">
                    ...
                    <div class="rightinnerdiv">
                        <div id="addperson" class="innerright portion" style="display:none">
                            <Button class="report-btn">ADD PERSON</Button>
                            <form action="addpersonserver_page.php" method="post" enctype="multipart/form-data">
                                <div class="addbook-input">
                                    <label>Name:</label><input type="text" name="addname" style="width: 250px;" />
                                </div>
                                <div class="addbook-input">
                                    <label>Pasword:</label><input type="password" name="addpass" style="width: 250px;" />
                                </div>
                                <div class="addbook-input">
                                    <label>Email:</label><input type="email" name="addemail" style="width: 250px;" />
                                </div>
                                <div class="addbook-input">
                                    <label for="typw">Choose Role:</label>
                                    <select name="type">
            ...
            padding: 8px;'> Name</th><th>Email</th><th>Role</th></tr>";
                            foreach ($recordset as $row) {
                                $table .= "<tr>";
                                "<td>$row[0]</td>";
                                $table .= "<td>$row[1]</td>";
                    ...
                    <div class="rightinnerdiv">
                        <div id="issuebookreport" class="innerright portion" style="display:none">
                            <Button class="report-btn">Issue Book Record</Button>
