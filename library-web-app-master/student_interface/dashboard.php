    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="innerdiv" style="padding-top: 8%;">
                ...
                <div class="role"><Button class="top-btn">WELCOME TO STUDENT DASHBOARD</Button></div>
                ...
                <!-- SEARCH BOOKS -->
                <div class="rightinnerdiv">
                    <div id="searchbook" class="innerright portion" style="display:none">
                        <!-- <Button class="report-btn detail">Search for your favorite books</Button> -->
                        <button type="submit" class="report-btn detail"><i class="fa fa-search"></i>&nbsp&nbspSearch for your favorite books</button>

                        <div class="input-group" style="margin-top: 20px;">
                            <input type="text" id="myInput" onkeyup="myFunction()" class="form-control" placeholder="Start typing...">
                        </div>

                        <ul id="myUL" style="margin-left: 20px;margin-top: -30px;">
                ...
                <div class="rightinnerdiv">
                    <div id="returnbook" class="innerright portion" style="display:none">
                        <Button class="report-btn detail">RETURN BOOK</Button>
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="table-responsive">
            ...
            padding: 8px;'>Book Name</th><th>Borrow Date</th><th>Return Date</th><th>Fine</th></th><th>Return</th></tr>";
                ...
                <div class="rightinnerdiv">
                    <div id="issuebookreport" class="innerright portion" style="display:none">
                        <Button class="report-btn detail">ISSUE REPORT</Button>
                        <div class="card shadow mb-4">
                            <div class="card-body">
                                <div class="table-responsive">
